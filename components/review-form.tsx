  ...
  return (
    <div className="mx-auto w-full max-w-2xl">
      <div className="mb-8 text-center">
        <h2 className="mb-2 text-2xl font-bold tracking-tight">Review Your Cover Letter</h2>
        <p className="text-muted-foreground">Edit and customize your cover letter content</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Feel free to edit the content above to personalize your cover letter.
          </p>
        </div>
