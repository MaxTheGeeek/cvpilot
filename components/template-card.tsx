    ...
    >
      ...
      <div className="relative aspect-[210/297] w-full overflow-hidden bg-muted/50">
        {template.image ? (
          ...
          /* Mock document preview fallback */
        ...
        {/* Selection indicator */}
        {isSelected && (
          <div className="absolute right-2 top-2 flex h-6 w-6 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-md z-10">
            <Check className="h-4 w-4" />
          </div>
        )}

        {/* Hover overlay */}
        <div className="absolute inset-0 flex items-center justify-center bg-primary/0 transition-colors group-hover:bg-primary/5 z-0">
          <span className={cn(
